    ...
    <AnimatePresence>
      {drawerShow && (
        <motion.form
          ...
          className={`fixed z-50 flex flex-col top-0 left-0 w-3/5 bg-slate-50 h-screen shadow-lg `}
        >
          ...
          <div className="flex flex-col justify-between p-4">
            ...
            >
              <h3 className="mb-4 text-lg font-semibold ">
                Estado : <small className="text-slate-500">{estado}</small>
              </h3>
            ...
            <section title="Quien" className="py-8 border-b border-b-slate-200">
              <h3 className="mb-4 text-lg font-semibold ">
                De : <small className="text-slate-500">{quien}</small>
              </h3>
              <div className="flex items-center justify-between space-x-2">
                {/* //* ---- ABDEL RADIO */}
                <label
            ...
            <section title="Donde" className="py-8 border-b border-b-slate-200">
              <h3 className="mb-4 text-lg font-semibold ">
                En : <small className="text-slate-500">{donde}</small>
              </h3>
              <div className="flex items-center justify-between space-x-2">
                {/* //* ---- MARRUECOS RADIO */}
                <label
